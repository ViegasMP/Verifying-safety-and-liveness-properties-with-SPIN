...
active [N] proctype Phil () {
	...
	do
		...
		/*Assert exc6*/
		if
		:: _pid!=N-1 -> assert(fork_num == _pid && fork_num2 == _pid+1 && forks[fork_num2] <= 1 && forks[fork_num] <= 1)
		:: else -> assert(fork_num == _pid && fork_num2 == 0 && forks[fork_num2] <= 1 && forks[fork_num] <= 1)
		fi
